...
headerContainer.innerHTML = `<nav class="navbar">
        <div class="maxwidth">
            ...
            <ul class="menu" id="menu">
                ...
                <li><a href="classes.html" class="menu-btn">Classes</a></li>
                <li><a href="https://ilearnar.wordpress.com" class="menu-btn">Free courses</a></li>
                
                <li class="dropdown"><a href="#" class="menu-btn">tutors</a>
                <ul class="submenu">
                    <li><a href="register.html">Find a tutor</a></li>
                    <li><a href="apply.html">Become a tutor</a></li>
                </ul>
                </li>
...
<div class="footer-links">
    ...
    <li> <a href="register.html">Connect with a tutor</a> </li>
    <li> <a href="apply.html">Become a tutor</a></li>
    </div>
